...
echo "PathToVM (Path to variability model) is the path to the .txt file containing the value domain of each configuration option (only required if installation has to be performed too). Can either be a valid path, or 'NONE' to indicate that no file exists.";
